...
export default class Edit extends Component {
     constructor(props){
        ...
        componentDidMount(){
            axios.get('http://127.0.0.1:8000/update/'+this.props.match.params.id)
            .then(response=>{
              this.setState({
        ...
        handelForumSubmit(e){
          ...
          axios.put('http://127.0.0.1:8000/edit/'+this.props.match.params.id,student)
          .then(response=>{
    ...
    render() 
    {
      return (
          <Fragment>
              <hr/>
              <div className="mb-3">
  < button type="submit" onClick={this.handleClean}  className="btn btn-primary">Clean</button>
</div>
